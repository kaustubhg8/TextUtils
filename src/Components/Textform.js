...
export default function Textform(props) {
  ...
  return (
    ...
    <div className='container'>
        ...
        <button className="btn btn-primary mx-1" onClick={handleRemoveExtraSpacesClick}>Remove extra spaces from the Text</button>
    ...
    <div className="container my-4">
      ...
      <p>Time required to read the para = {text.split(' ').length * 0.008} Minuts </p>
      <h2>Preview</h2>
      <p>{text}</p>
    </div>
